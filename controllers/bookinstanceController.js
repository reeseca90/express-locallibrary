...
exports.bookinstance_delete_get = function(req, res, next) {
  BookInstance.findById(req.params.id).exec(function (err, instance) {
    if (err) { return next(err); }
    // success, render
    res.render('bookinstance_delete', { title: 'Delete Book Instance', book_instance: instance});
  });
};

// Handle BookInstance delete on POST.
exports.bookinstance_delete_post = function(req, res, next) {
  BookInstance.findByIdAndRemove(req.params.id, function deleteInstance (err) {
    if (err) { return next(err); }
    // success, render book instance list
